...
from alpsbench_public import evaluate_structured_candidate, score_task4, _task4_prediction_payload
...
def evaluate_candidate(*, task, candidate_path, source_code, baseline_metrics, memory_applied):
    ...
    return evaluate_structured_candidate(
        ...
        parse_expectation='JSON utilization output: {"answer": "...", "used_memory_fact": "..."}',
        payload_builder=_task4_prediction_payload,
        score_fn=score_task4,
    )
