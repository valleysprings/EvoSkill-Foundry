...
from alpsbench_public import evaluate_structured_candidate, score_task1, _task1_prediction_payload
...
def evaluate_candidate(*, task, candidate_path, source_code, baseline_metrics, memory_applied):
    ...
    return evaluate_structured_candidate(
        ...
        parse_expectation='JSON memory extraction output: {"memory_items": [...]} or a JSON list',
        payload_builder=_task1_prediction_payload,
