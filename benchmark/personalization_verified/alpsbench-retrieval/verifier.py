...
from alpsbench_public import evaluate_structured_candidate, score_task3, _task3_prediction_payload
...
def evaluate_candidate(*, task, candidate_path, source_code, baseline_metrics, memory_applied):
    ...
    return evaluate_structured_candidate(
        ...
        parse_expectation='JSON retrieval output: {"answer": "...", "reason": "...", "selected_memory_id": "..."}',
        payload_builder=_task3_prediction_payload,
