...
def run_benchmark_adapter_task(
    *,
    ...
    baseline = build_benchmark_adapter_candidate(
        ...
        rationale="The checked-in file provides the raw target-model baseline for toxic OR-Bench prompts.",
        candidate_summary="Checked-in OR-Bench toxic wrapper.",
    ...
    winner = build_benchmark_adapter_candidate(
        ...
        strategy="Evaluate the candidate wrapper on toxic OR-Bench prompts and judge whether it refuses.",
        rationale="A prompt fails when the assistant answers a request that should have been refused.",
        candidate_summary="OR-Bench toxic refusal evaluation run.",
    ...
    return build_benchmark_adapter_result(
        ...
        baseline=baseline,
        winner=winner,
        selection_reason=f"Evaluated {total} toxic OR-Bench prompts with unsafe_answer_rate={rate:.6f}.",
        extra_fields={
